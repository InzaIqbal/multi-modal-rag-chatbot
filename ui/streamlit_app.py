...
def apply_custom_styles():
    ...
    <style>
        ...
        :root {
            ...
            --primary-500: #7c5cff;      /* Primary violet */
            --primary-600: #6d43ff;
            --primary-700: #5b32e0;
            --primary-rgb: 124, 92, 255; /* used for rgba() overlays below */
            
            /* Neutral palette (kept, only used as fallback greys) */
            --neutral-50: #f9fafb;
            --neutral-100: #f3f4f6;
            --neutral-200: #e5e7eb;
            --neutral-300: #d1d5db;
            ...
            /* Functional colors */
            --text-primary: #1c1730;
            --text-secondary: #6f6a8a;
            --border-color: #e6e2f5;
            --bg-surface: #ffffff;
            --bg-elevated: #f6f4fd;
            
            /* Sidebar (dark, matches reference image) */
            --sidebar-bg: #16121f;
            --sidebar-bg-elevated: #1e1930;
            --sidebar-text: #e7e3f7;
            --sidebar-text-secondary: #9d97bd;
            --sidebar-border: #2c2645;
        ...
        @media (prefers-color-scheme: dark) {
            :root {
                --text-primary: #e7e3f7;
                --text-secondary: #9d97bd;
                --border-color: #2c2645;
                --bg-surface: #16121f;
                --bg-elevated: #1e1930;
                --assistant-bg: #241f3a;
                --assistant-text: #e7e3f7;
            }
        }
        ...
        * {
        ...
        /* Intentional highlight for the flagship feature card only */
        ...
        /* Remove stray focus/tab outlines that can appear on the first
           focusable card-like element in the grid */
        .feature-card:focus,
        ...
        .main .block-container *:focus-visible {
            outline: none !important;
        }
        ...
        /* Sidebar text/headers/captions in light lavender so they read on dark bg */
        ...
        /* Sidebar expanders / file uploader get the slightly-lighter elevated panel */
        [data-testid="stSidebar"] .streamlit-expanderHeader,
        [data-testid="stSidebar"] .stFileUploader,
        [data-testid="stSidebar"] [data-testid="stExpander"] {
            background-color: var(--sidebar-bg-elevated) !important;
...
def render_welcome_screen():
    ...
    st.markdown(
        ...
        <div class="welcome-container">
            ...
            <div class="welcome-cta">
                <span>👈 Use the sidebar to upload your first document</span>
            </div>
        </div>
        """,
        unsafe_allow_html=True
    ...
    # Features grid - one card (AI Powered) intentionally highlighted as the flagship feature
    st.markdown(
        """
        <div class="features-grid">
            ...
            <div class="feature-card primary">
                ...
                <div class="feature-description">Fast inference via Groq</div>
            </div>
            <div class="feature-card">
